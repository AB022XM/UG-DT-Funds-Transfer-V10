...
To build the final jar and optimize the FundsTransfer application for production, run:
...
Then navigate to [http://localhost:90021](http://localhost:90021) in your browser.
